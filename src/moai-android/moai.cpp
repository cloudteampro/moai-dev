...
//================================================================//
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUAppInitialize ( JNIEnv* env, jclass obj ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUEnqueueCompassEvent ( JNIEnv* env, jclass obj, jint deviceId, jint sensorId, jfloat heading ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUEnqueueLevelEvent ( JNIEnv* env, jclass obj, jint deviceId, jint sensorId, jfloat x, jfloat y, jfloat z ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUEnqueueLocationEvent ( JNIEnv* env, jclass obj, jint deviceId, jint sensorId, jdouble longitude, jdouble latitude, jdouble altitude, jfloat hAccuracy, jfloat vAccuracy, jfloat speed ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUEnqueueTouchEvent ( JNIEnv* env, jclass obj, jint deviceId, jint sensorId, jint touchId, jboolean down, jint x, jint y ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUModulesUpdate ( JNIEnv* env, jclass obj ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUMountVirtualDirectory ( JNIEnv* env, jclass obj, jstring jvirtualPath, jstring jarchive ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUPause ( JNIEnv* env, jclass obj, jboolean paused ) {

		AKUModulesPause ( paused );
	}

	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKURender ( JNIEnv* env, jclass obj ) {

		AKURender ();
	}

	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUReserveInputDevices ( JNIEnv* env, jclass obj, jint total ) {

		AKUReserveInputDevices ( total );
	}

	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUReserveInputDeviceSensors ( JNIEnv* env, jclass obj, jint deviceId, jint total ) {

		AKUReserveInputDeviceSensors ( deviceId, total );
	}

	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKURunScript ( JNIEnv* env, jclass obj, jstring jfilename ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetConnectionType ( JNIEnv* env, jclass obj, jlong connectionType ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetDeviceLocale ( JNIEnv* env, jclass obj, jstring jlangCode, jstring jcountryCode ) {
	...
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetDeviceProperties ( JNIEnv* env, jclass obj, jstring jappName, jstring jappId, jstring jappVersionName, jstring jappVersionCode, jstring jabi, jstring jdevBrand, jstring jdevName, jstring jdevManufacturer, jstring jdevModel, jstring jdevProduct, jint jnumProcessors, jstring josBrand, jstring josVersion, jstring josBuild, jstring judid ) {
		...
		environment.SetValue ( MOAI_ENV_numProcessors,			( int )jnumProcessors );
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetDocumentDirectory ( JNIEnv* env, jclass obj, jstring jpath ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetCacheDirectory ( JNIEnv* env, jclass obj, jstring jpath ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetInputConfigurationName ( JNIEnv* env, jclass obj, jstring jname ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetInputDevice ( JNIEnv* env, jclass obj, jint deviceId, jstring jname ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetInputDeviceCompass ( JNIEnv* env, jclass obj, jint deviceId, jint sensorId, jstring jname ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetInputDeviceLevel ( JNIEnv* env, jclass obj, jint deviceId, jint sensorId, jstring jname ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetInputDeviceLocation ( JNIEnv* env, jclass obj, jint deviceId, jint sensorId, jstring jname ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetInputDeviceTouch ( JNIEnv* env, jclass obj, jint deviceId, jint sensorId, jstring jname ) {
	...
	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetScreenDpi ( JNIEnv* env, jclass obj, jint dpi ) {

		AKUSetScreenDpi ( dpi );
	}

	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetScreenSize ( JNIEnv* env, jclass obj, jint width, jint height ) {

		AKUSetScreenSize ( width, height );
	}

	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetViewSize ( JNIEnv* env, jclass obj, jint width, jint height ) {

		AKUSetViewSize ( width, height );
	}

	//----------------------------------------------------------------//
	extern "C" JNIEXPORT void JNICALL Java_com_moaisdk_core_Moai_AKUSetWorkingDirectory ( JNIEnv* env, jclass obj, jstring jpath ) {
