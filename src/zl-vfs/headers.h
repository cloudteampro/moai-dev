...
extern void					zl_flockfile			( ZLFILE* fp );
...
extern int					zl_ftrylockfile			( ZLFILE* fp );
extern void					zl_funlockfile			( ZLFILE* fp );
...
extern wchar_t				zl_ungetwc             	( wchar_t character, ZLFILE* fp);
