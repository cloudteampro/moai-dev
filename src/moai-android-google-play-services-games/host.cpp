...
//----------------------------------------------------------------//
void AKUAndroidGooglePlayServicesGamesAppFinalize () {
}

//----------------------------------------------------------------//
void AKUAndroidGooglePlayServicesGamesAppInitialize () {
}

//----------------------------------------------------------------//
void AKUAndroidGooglePlayServicesGamesContextInitialize () {

	REGISTER_LUA_CLASS ( MOAIGooglePlayServicesGamesAndroid );
