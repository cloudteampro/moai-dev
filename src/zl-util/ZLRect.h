...
public:
	...
	//----------------------------------------------------------------//
	void Constrain ( ZLMetaRect < TYPE >& rect ) const {
	...
	void ConstrainWithAspect ( ZLMetaRect < TYPE >& rect ) const {
	...
	//----------------------------------------------------------------//
	bool Contains ( const ZLMetaVec3D < TYPE >& loc ) const {
	...
	//----------------------------------------------------------------//
	bool Contains ( const ZLMetaVec2D < TYPE >& loc ) const {
	...
	//----------------------------------------------------------------//
	bool Contains ( ZLMetaRect < TYPE >& rect ) const {
	...
	void FitInside ( ZLMetaRect < TYPE >& rect ) const {
	...
	//----------------------------------------------------------------//
	// Centers and fits rect while preserving its aspect ratio
	void FitOutside ( ZLMetaRect < TYPE >& rect ) const {
	...
	//----------------------------------------------------------------//
	bool GetIntersection ( ZLMetaVec2D < TYPE >& loc, ZLMetaVec2D < TYPE >& vec, ZLMetaVec2D < TYPE >& p0, ZLMetaVec2D < TYPE >& p1 ) {

		u32 count = 0;
		ZLMetaVec2D < TYPE > sect [ 3 ];
	...
	//----------------------------------------------------------------//
	ZLMetaVec2D < TYPE > GetNearestPoint ( const ZLMetaVec2D < TYPE >& point ) const {
	...
	//----------------------------------------------------------------//
	template < typename PARAM_TYPE >
	void Grow ( ZLMetaVec3D < PARAM_TYPE >& vec ) {
	...
	//----------------------------------------------------------------//
	template < typename PARAM_TYPE >
	void Grow ( const ZLMetaVec2D < PARAM_TYPE >& point ) {
	...
	//----------------------------------------------------------------//
	bool Intersect ( const ZLMetaRect < TYPE >& rect, ZLMetaRect < TYPE >& result ) const {
	...
	//----------------------------------------------------------------//
	bool Overlap ( const ZLMetaRect < TYPE >& rect ) const {
	...
	//----------------------------------------------------------------//
	bool Overlap ( const ZLMetaVec2D < TYPE >& point, float radius ) const {
		
		ZLMetaVec2D < TYPE > nearest = this->GetNearestPoint ( point );
	...
	//----------------------------------------------------------------//
	void TransformLocalToWorld ( ZLMetaRect < TYPE >& rect ) const {
	...
	//----------------------------------------------------------------//
	void TransformWorldToLocal ( ZLMetaRect < TYPE >& rect ) const {
