...
public:
	...
	//----------------------------------------------------------------//
	ZLMetaVec3D < TYPE > GetScale () const {
	...
	//----------------------------------------------------------------//
	ZLMetaVec3D < TYPE > GetTranslation () const {
	...
	//----------------------------------------------------------------//
	bool Inverse ( const ZLMetaAffine3D < TYPE >& mtx ) {
	...
	//----------------------------------------------------------------//
	bool IsSame ( const ZLMetaAffine3D < TYPE >& compare ) const {
	...
	//----------------------------------------------------------------//
	void Prepend ( const ZLMetaAffine3D < TYPE >& mtx ) {
	...
	//----------------------------------------------------------------//
	void Scale ( const ZLMetaVec3D < TYPE >& scl ) {
